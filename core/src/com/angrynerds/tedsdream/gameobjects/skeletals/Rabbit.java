...
public class Rabbit extends Creature {
    ...
    public Rabbit(TextureAtlas atlas, float scale, float ap, float hp, float x, float y) {
        super(atlas, "spine/hase/hase", scale, null, ap, hp, x, y);
    ...
    public static Rabbit create(TextureAtlas atlas) {
        ...
        return new Rabbit(atlas, scale, ap, hp, 0, 0);
    }
